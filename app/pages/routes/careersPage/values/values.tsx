    ...
    return (
        <section className="flex flex-col phone:gap-[50px] 2xl:gap-[60px] 4xl:gap-[80px] phone:mt-[80px] 2xl:mt-[120px] phone:mx-[20px] 2xl:mx-[80px]">
            <div className="flex flex-col gap-[20px]">
                <p className="font-[Lexend-Medium] text-white phone:text-[28px] 2xl:text-[38px] 4xl:text-[48px] leading-[150%] phone:text-center 2xl:text-left">Our <span className="text-[#CAFF33]">Values</span></p>
            ...
            <div className="phone:grid 2xl:grid 2xl:grid-cols-2 phone:gap-[50px] 2xl:gap-[60px] 4xl:gap-[80px]">
                <div className="border-l-[1px] border-l-[#CAFF33] phone:pl-[20px] 2xl:pl-[24px] 4xl:pl-[30px] flex flex-col phone:gap-[14px] 2xl:gap-[20px]">
                    <p className="font-[Lexend-Medium] phone:text-[30px] 2xl:text-[40px] 4xl:text-[58px] text-[#4C4C4D]">Integrity</p>
                ...
                <div className="border-l-[1px] border-l-[#CAFF33] phone:pl-[20px] 2xl:pl-[24px] 4xl:pl-[30px] flex flex-col phone:gap-[14px] 2xl:gap-[20px]">
                    <p className="font-[Lexend-Medium] phone:text-[30px] 2xl:text-[40px] 4xl:text-[58px] text-[#4C4C4D]">Customer Centricity</p>
                    <p className="font-[Lexend-Light] phone:text-[14px] 2xl:text-[16px] 4xl:text-[18px] text-[#B3B3B3]">
                ...
                <div className="border-l-[1px] border-l-[#CAFF33] phone:pl-[20px] 2xl:pl-[24px] 4xl:pl-[30px] flex flex-col phone:gap-[14px] 2xl:gap-[20px]">
                    <p className="font-[Lexend-Medium] phone:text-[30px] 2xl:text-[40px] 4xl:text-[58px] text-[#4C4C4D]">Collaboration</p>
                    <p className="font-[Lexend-Light] phone:text-[14px] 2xl:text-[16px] 4xl:text-[18px] text-[#B3B3B3]">
                ...
                <div className="border-l-[1px] border-l-[#CAFF33] phone:pl-[20px] 2xl:pl-[24px] 4xl:pl-[30px] flex flex-col phone:gap-[14px] 2xl:gap-[20px]">
                    <p className="font-[Lexend-Medium] phone:text-[30px] 2xl:text-[40px] 4xl:text-[58px] text-[#4C4C4D]">Innovation</p>
                    <p className="font-[Lexend-Light] phone:text-[14px] 2xl:text-[16px] 4xl:text-[18px] text-[#B3B3B3]">
