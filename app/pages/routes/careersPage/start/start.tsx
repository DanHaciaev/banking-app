...
export default function Start() {
    return (
        <section className="relative flex justify-between phone:gap-[24px] 2xl:gap-[80px] phone:mt-[120px] 2xl:my-[120px] phone:mx-[20px] 2xl:mx-[80px] phone:p-[30px] 2xl:p-[60px] 4xl:p-[80px] phone:flex-col 2xl:flex-row items-center bg-[#1C1C1C] border-[1px] border-[#262626] rounded-[20px]">
