        ...
        <section className="flex flex-col phone:gap-[60px] 4xl:gap-[80px] phone:mt-[80px] 2xl:mt-[120px] phone:mx-[20px] 2xl:mx-[80px]">
            <div className="flex flex-col gap-[20px]">
                ...
                <p className="text-[#E4E4E7] phone:text-[14px] 2xl:text-[16px] 4xl:text-[18px] phone:text-center 2xl:text-left">
                    ...
                    technology and stringent data protection
                    measures ensure your assets and transactions
                ...
                <div className="bg-[linear-gradient(114deg,rgba(202,255,51,0.1)_0%,rgba(38,38,38,0)_17%,rgba(38,38,38,0)_69%,rgba(38,38,38,0.8)_100%)] rounded-[20px] phone:p-[24px] 2xl:p-[40px] 4xl:p-[50px] border-[1px] border-[#262626] flex flex-col gap-[40px]">
                    <div className="flex items-center phone:gap-[30px] 2xl:gap-[40px] 4xl:gap-[50px] ml-[25px]">
                        <div className="relative flex items-center justify-center mt-[20px]">
                            ...
                            <div className="absolute phone:w-[72px] phone:h-[72px] 2xl:w-[76px] 2xl:h-[76px] 4xl:w-[98px] 4xl:h-[98px] rounded-full bg-[#CAFF33] opacity-5 "></div>

                            <div className="absolute z-10 phone:w-[56px] phone:h-[56px] 2xl:w-[60px] 2xl:h-[60px] 4xl:w-[74px] 4xl:h-[74px] flex items-center justify-center rounded-full bg-gradient-to-b from-[#CAFF33] to-transparent via-[#CAFF33]/0 via-47% opacity-10">
                            </div>

                            <div className="relative z-20 flex items-center justify-center phone:w-[24px] phone:h-[24px] 2xl:w-[28px] 2xl:h-[28px] 4xl:w-[34px] 4xl:h-[34px]">
                                <img src="/security/secure.png" alt="Startups and Entrepreneurs" className="phone:w-[24px] 2xl:w-[28px] 4xl:w-[34px] opacity-100" />
                            </div>
                        </div>
                ...
                <div className="bg-[linear-gradient(114deg,rgba(202,255,51,0.1)_0%,rgba(38,38,38,0)_17%,rgba(38,38,38,0)_69%,rgba(38,38,38,0.8)_100%)] rounded-[20px] phone:p-[24px] 2xl:p-[40px] 4xl:p-[50px] border-[1px] border-[#262626] flex flex-col gap-[40px]">
                    <div className="flex items-center phone:gap-[30px] 2xl:gap-[40px] 4xl:gap-[50px] ml-[25px]">
                        <div className="relative flex items-center justify-center mt-[20px]">
                            ...
                            <div className="relative z-20 flex items-center justify-center phone:w-[24px] phone:h-[24px] 2xl:w-[28px] 2xl:h-[28px] 4xl:w-[34px] 4xl:h-[34px]">
                                <img src="/security/multi.png" alt="Startups and Entrepreneurs" className="phone:w-[24px] 2xl:w-[28px] 4xl:w-[34px] opacity-100" />
                            </div>
                        </div>
                ...
                <div className="bg-[linear-gradient(114deg,rgba(202,255,51,0.1)_0%,rgba(38,38,38,0)_17%,rgba(38,38,38,0)_69%,rgba(38,38,38,0.8)_100%)] rounded-[20px] phone:p-[24px] 2xl:p-[40px] 4xl:p-[50px] border-[1px] border-[#262626] flex flex-col gap-[40px]">
                    <div className="flex items-center phone:gap-[30px] 2xl:gap-[40px] 4xl:gap-[50px] ml-[25px]">
                        <div className="relative flex items-center justify-center mt-[20px]">
                            ...
                            <div className="relative z-20 flex items-center justify-center phone:w-[24px] phone:h-[24px] 2xl:w-[28px] 2xl:h-[28px] 4xl:w-[34px] 4xl:h-[34px]">
                                <img src="/security/fraud.png" alt="Startups and Entrepreneurs" className="phone:w-[24px] 2xl:w-[28px] 4xl:w-[34px] opacity-100" />
                            </div>
                        </div>
                ...
                <div className="bg-[linear-gradient(114deg,rgba(202,255,51,0.1)_0%,rgba(38,38,38,0)_17%,rgba(38,38,38,0)_69%,rgba(38,38,38,0.8)_100%)] rounded-[20px] phone:p-[24px] 2xl:p-[40px] 4xl:p-[50px] border-[1px] border-[#262626] flex flex-col gap-[40px]">
                    <div className="flex items-center phone:gap-[30px] 2xl:gap-[40px] 4xl:gap-[50px] ml-[25px]">
                        <div className="relative flex items-center justify-center mt-[20px]">
                            ...
                            <div className="relative z-20 flex items-center justify-center phone:w-[24px] phone:h-[24px] 2xl:w-[28px] 2xl:h-[28px] 4xl:w-[34px] 4xl:h-[34px]">
                                <img src="/security/mobile.png" alt="Startups and Entrepreneurs" className="phone:w-[24px] 2xl:w-[28px] 4xl:w-[34px] opacity-100" />
                            </div>
                        </div>
