...
import { Eye, EyeOff } from "lucide-react"; // Иконки глазика

export default function LoginForm() {
    const [showPassword, setShowPassword] = useState(false);

    return (
        <section className="max-w-[1064px] h-fit bg-cover bg-no-repeat bg-center mt-[50px] flex items-center gap-[60px] flex-col mx-auto relative px-[200px] py-[80px]" style={{ backgroundImage: "url('/login/Login.png')" }}>
            <img src="/login/abstract.png" alt="" className="absolute z-[9999] w-[256px] h-[243px] right-0 top-0" />

            <div className="flex flex-col gap-[16px] items-center">
                <p className="text-[#CAFF33] text-[38px]">Login</p>
            ...
            <form action="" className="flex flex-col items-center gap-[30px]">
                ...
                <div className="w-[404px] flex flex-col gap-[24px]">
                    <button className="bg-[#CAFF33] rounded-[63px] px-[24px] py-[14px] text-[14px]">Login</button>
                    <button className="bg-[#262626] rounded-[63px] px-[24px] py-[14px] text-[14px] text-white border-[1px] border-[#333333]">Sign Up</button>
                </div>
